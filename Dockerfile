...
RUN apt-get update && apt-get install -y curl vim g++ git automake frei0r-plugins-dev ladspa-sdk libladspa-ocaml-dev libiec61883-dev libass-dev libbluray-dev libbs2b-dev \
